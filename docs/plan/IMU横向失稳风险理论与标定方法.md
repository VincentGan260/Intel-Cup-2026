...
| 候选 | 当前用途 | 能否称为理论值 |
|---|---|---|
| `roll_error_critical: 20°/25°/30°` | 当前25°附近的实车搜索边界 | 不能 |
| `roll_attention: 8°/10°/12°` | 当前10°附近的早期关注搜索点 | 不能 |
| 中风险`outward_rate: 3/5/7°/s` | 当前5°/s附近的搜索点 | 不能 |
| 高风险`outward_rate: 8/10/12°/s` | 当前10°/s附近的搜索点 | 不能 |
| `attention_persistence: 100/150/200 ms` | 当前150 ms附近的抗尖峰搜索点 | 不能 |
| 高风险3个连续样本 | 20 Hz风险循环下约100 ms的一致性候选 | 不能 |
| `prediction_horizon: 0.6/0.8/1.0 s` | 当前0.8 s附近的短时预测范围 | 不能 |
